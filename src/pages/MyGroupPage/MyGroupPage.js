...
import ProfilePageCard from "../../components/Card/ProfilePageCard";
...
const MyGroupPage = () => {
  ...
  const AddPost = async (e) => {
    ...
    if (status == 200) {
      ...
      let r = await API.post(`/group/${id}/post`, newdata);
      console.log(r);
      setImg("");
      getGroupData();
    }
  ...
  const getAllPost = async () => {
    console.log("hello");
    let r = await API.get(`/group/${id}/posts`);
          ...
          <TextFieldsContainer style={{ width: "100%" }}>
            <InputFieldContainer>
              <InputField
                ...
                onChange={(e) =>
                  setGroupinfo({ ...Groupinfo, title: e.target.value })
                }
              />
            </InputFieldContainer>
            ...
            <div class="button-container">
              <button className="SaveButton" onClick={handleUpdateGroup}>
                Update
              </button>
            </div>
          </TextFieldsContainer>
          ...
          <UserContainer>
            <UserProfileContainer>
              <div
                ...
                style={{ background: `url(${groupdata.coverImage})` }}
              ></div>
              <div className="card-body">
                ...
                <div className="post-setting" style={{ position: "relative" }}>
                  <div
                    className="animate__animated animate__zoomIn setting-data"
                    style={
                      showSetting == false
                        ? { display: "none" }
                      ...
                      <div className="postcontainer">
                        ...
                        <div className="post-footer">
                          ...
                          <div>
                            ...
                            />
                            <p onClick={() => handleDropDown("click")}>
                              {postType}
                            </p>
                            <div
