...
import {UserProfileContainer,UserTabContainer,UserContainer,FriendsContainer,FriendsCardContainer} from "./Userprofile.style"
...
const Userprofile = ({page}) => {
  ...
  return (
    ...
    <div className='sidebar-container'>
            ...
            <div className='background-img' style={{background:`url(${GroupImg2})`}}></div>
            <div className='card-body'>
       <div className='avatar-container'>
       <Avatar alt="Cindy Baker" src={userImg} sx={{cursor:"pointer",width:"100px",height:"100px"}}/>
       </div>
      ...
      <TabContext value={value}>
        ...
        <TabPanel value="1"><AllPostContainer >
    <Post />
    <Post />
    <Post/>
    <Post/>
