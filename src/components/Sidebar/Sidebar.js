    ...
    <>
      <SidebarNews>
        ...
        <div className="Avatar-container">
          ...
          />
          <NotificationAvatar
            gradient="linear-gradient(135deg,#05f,#09f)!important"
            txt="Profile"
            link="/MyProfile"
            icon={<PersonOutlinedIcon style={{ color: "white" }} />}
          />
          <NotificationAvatar
            gradient="linear-gradient(135deg,#A020F0,#6C0BA9)!important"
            txt="Notifications"
            link="/Home"
            icon={<NotificationsNoneOutlinedIcon style={{ color: "white" }} />}
          />
          <NotificationAvatar
            gradient="linear-gradient(to right,#ee0979,#ff6a00)!important"
            txt="Messages"
            link="/Chat"
            icon={<ChatBubbleOutlineOutlinedIcon style={{ color: "white" }} />}
          />
          <NotificationAvatar
            gradient="linear-gradient(to right,#e44d26,#f16529)!important"
            txt="Find Users"
          ...
          <NotificationAvatar
            ...
            txt="Create Page"
            link="/CreatePage"
            icon={<PagesIcon style={{ color: "white" }} />}
          />
          <NotificationAvatar
            gradient="linear-gradient(to right,#ee0979,#ff6a00)!important"
            txt="Create Group"
            link="/CreateGroup"
            icon={<GroupAddIcon style={{ color: "white" }} />}
          />
        </div>
      </SidebarNews>
      <SidebarSetting>
